...
export const metadata: Metadata = {
  title: "Login",
  description: "Secure login to your Aurevault Precious Metals account. Access your vault, tracking, and portfolio management.",
  openGraph: {
  ...
  twitter: {
    ...
    title: "Login | Aurevault Precious Metals Pty LTD",
    description: "Secure login to access your precious metals vault and portfolio.",
  },
  robots: {
    index: false,
    follow: true,
